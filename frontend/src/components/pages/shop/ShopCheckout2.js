        ...
        <Fragment>
            ...
            <div id="content">
                ...
                <div className="row">
                    ...
                    <div className="box">
                        <form method="get" action="/shop-checkout3">
                            <ul className="nav nav-pills nav-fill">
                                ...
                                <li className="nav-item"><Link to="/shop-checkout2" className="nav-link active"><i className="fa fa-truck"></i><br/>Método de entrega</Link></li>
                        ...
                        <div className="content">
                            ...
                            <div className="box-footer d-flex flex-wrap align-items-center justify-content-between">
                                <div className="left-col"><Link to="/shop-checkout1" className="btn btn-secondary mt-0"><i className="fa fa-chevron-left"></i>Volver a la dirección</Link></div>
                                <div className="right-col">
                                <button type="submit" className="btn btn-main">Continuar al método de pago<i className="fa fa-chevron-right"></i></button>
                                </div>
                            </div>
                        </form>
                    </div>
