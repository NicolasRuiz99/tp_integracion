...
const ShopCheckout1 = ({route,coupon,setCoupon,cartInfo}) => {
    return (
        <Fragment>
                ...
                <div className="row">
                    ...
                    <div className="box border-bottom-0">
                        <ul className="nav nav-pills nav-fill">
                            <li className="nav-item"><Link to={`${route}/1`} className="nav-link active"> <i className="fa fa-map-marker"></i><br/>Dirección</Link></li>
                        ...
                        <div className="box-footer d-flex flex-wrap align-items-center justify-content-between">
                            ...
                            <Link to={`${route}/2`} className="btn btn-main">Continuar al método de entrega<i className="fa fa-chevron-right"></i></Link>
                            </div>
                        </div>
                    </div>
                    </div>
