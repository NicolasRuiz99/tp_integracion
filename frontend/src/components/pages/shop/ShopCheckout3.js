...
const ShopCheckout3 = ({route,coupon,setCoupon,cartInfo}) => {
    return (
        <Fragment>
            ...
            <div id="checkout" className="col-lg-9">
              <div className="box">
                  ...
                  <div className="box-footer d-flex flex-wrap align-items-center justify-content-between">
                    <div className="left-col"><Link to={`${route}/2`} className="btn btn-secondary mt-0"><i className="fa fa-chevron-left"></i>Volver al método de envío</Link></div>
