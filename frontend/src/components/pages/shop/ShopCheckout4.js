              ...
              <div className="box">
                <form method="get" action="/shop-checkout4">
                  <ul className="nav nav-pills nav-fill">
                    ...
                    <li className="nav-item"><Link to="/shop-checkout3" className="nav-link"><i className="fa fa-money"></i><br/>Método de pago</Link></li>
                    <li className="nav-item"><Link to="/shop-checkout4" className="nav-link active"><i className="fa fa-eye"></i><br/>Revisión de la compra</Link></li>
                  </ul>
                </form>
                ...
                <div className="box-footer d-flex flex-wrap align-items-center justify-content-between">
                  <div className="left-col"><Link to="/shop-checkout3" className="btn btn-secondary mt-0"><i className="fa fa-chevron-left"></i>Volver al método de pago</Link></div>
